...
<div class="container mt-5">
    <h2>Data Periksa</h2>
    <form name="periksa" action="simpan_periksa.php" method="POST">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="hapus_periksa.php?id=<?php echo $ambil_data['id_periksa']?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus ini ?')">Hapus</a>
                        <a href="nota.php?id=<?php echo $ambil_data['id_periksa']?>" class="btn-warning">nota</a>
                    </td>
                </tr>
            <?php
            }
